import MatchyMatchy from "../components/MatchyMatchy";

export default function MatchyMatchyPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-4 text-muted-foreground">
            🏆 Awarded <strong>100%</strong> and ranked
            <strong> 1st out of 331 students</strong>.
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <ul className="space-y-3 text-muted-foreground">
            <li>• Press <strong>F</strong> to cycle through the cannon shapes.</li>
            <li>• Press <strong>J</strong> to fire.</li>
            <li>• Match the cannon's shape to the incoming invader.</li>
